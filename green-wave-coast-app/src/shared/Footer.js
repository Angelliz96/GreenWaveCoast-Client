    ...
    <footer>
      <div className="footerAllPages">
        ...
        <div className="followUs">
          <h2>Follow us</h2>
          <ul>
            <li><a href="https://www.linkedin.com/in/angely-lizcano-719386280/" target="_blank" rel="noopener noreferrer">LinkedIn</a></li>
            <li><a href="https://github.com/Angelliz96" target="_blank" rel="noopener noreferrer">GitHub</a></li>
